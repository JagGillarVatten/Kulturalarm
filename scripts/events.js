...
// Set the current event file to the first one in the list
const currentEventFile = eventFiles[0];
...
function getNextEvent() {
    ...
    // Load the first event file by default
    loadJSON(currentEventFile.url);
